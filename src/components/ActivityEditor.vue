<template>
  <div v-if="activity" class="q-pa-md">
    <q-input v-model="activity.name" label="Name" color="accent" outlined stack-label class="q-mb-sm" />
    <q-input label="Description" v-model="activity.description" color="accent" filled type="textarea" />
    <q-btn label="Delete" color="negative" icon="delete" @click="deleteActivity" class="q-mt-md full-width" />
  </div>
